    ...
    <form method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-4 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="<?php echo isset($theImg)? $theImg : "images/external-content.duckduckgo.com.jpeg"; ?>" width="90"><span class="font-weight-bold"><?php echo $userinfo['firstname']." ".$userinfo['lastname']; ?></span><span class="text-black-50"><?php echo $userinfo['email']; ?></span><span><?php echo $userinfo['country']; ?></span></div>
