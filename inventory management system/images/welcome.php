...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
				<div class="p-4 pt-5">
		  		<a href="#" class="img logo rounded-circle mb-5" style="background-image: url(<?php echo $theImg; ?>);"></a>
            ...
            ?>
              ...
              <!-- <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">All users</a>
              <ul class="collapse list-unstyled" id="pageSubmenu">
                <li>
                    <a href="allUsers.php">Page 1</a>
                </li>
