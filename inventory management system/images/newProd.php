		...
		if(isset($_POST['addnew'])){
			...
			for($i=0;$i<$countFile;$i++){
				...
				if(move_uploaded_file($fielTmp,$targetDir)){
					...
					$uploadImg ="INSERT INTO `products`(`img`,) VALUES ('".$targetDir."')"; 

					$uplImgRes = $conn->query($uploadImg);	
					echo "uploaded file successfylly !";
				}else{
	...
	<div class="wrapper">
		...
		<form method="post" class="form" enctype="multipart/form-data">
			...
			<div class="input-field">
				...
				<textarea style="text" rows="5" cols="20" name="des"></textarea>
