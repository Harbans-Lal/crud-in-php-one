<?php
  ...
  if(isset($_POST['signup'])){
    ...
    if(!$nameShoulCharOnly){
      $fnameErr = '<span style="color:red;"> First name must contains characters only</span>';
    }
    ...
    if(!$nameShoulCharOnlyll){
      $lnameErr = '<span style="color:red;"> Last name must contains characters only</span>';
    }
    ...
    $errr = $fnameErr || $lnameErr || $passErr || $confirmErr || $emailErr!='' ;
...
<body>
  ...
  <div class="form" method="post" >
      ...
      <ul class="top-area">
        <li class="tab <?php echo !isset($_REQUEST['login'])? 'active' : ''; ?>"><a href="#signup">Sign Up</a></li>
        <li class="tab <?php  if(isset($_REQUEST['login'])){
      ...
      <div class="tab-content">
        <div id="signup" style="<?php echo $sty2; ?>" >   
          ...
          <div class="top-row">
            <div class="label-field">
              ...
              <input type="text" name="first_name" value="<?php echo $errr ? $firstname : ''; ?>" required autocomplete="off" />
            ...
            <div class="label-field">
              ...
              <input type="text" name="last_name" value="<?php echo $errr ? $lastname : ''; ?>" required autocomplete="off"/>
          ...
          <div class="label-field">
            ...
            <input type="email" name="email" value="<?php echo $errr ? $email : ''; ?>" required autocomplete="off"/>
          ...
          <div class="label-field">
            ...
            <input type="password" name="password" value="<?php echo $errr ? $password : ''; ?>" required autocomplete="off"/>
          </div>
          <div class="label-field">
            <label>
              Confirm A Password<span class="req">*</span>
            </label>
            <input type="password" name="confirm_password" value="<?php echo $errr ? $confirmpassword :''; ?>" required autocomplete="off"/>
        ...
        <div id="login" style="<?php echo $sty; ?>">   
          <h1>Welcome Back!</h1>
